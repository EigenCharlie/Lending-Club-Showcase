...
_ARCH_NODES = [
    ...
    {"id": "pd", "label": "PD Model", "layer": "model", "detail": "CatBoost + Platt · AUC=0.7187", "icon": "\U0001F3AF"},
    {"id": "conformal", "label": "Conformal Mondrian", "layer": "model", "detail": "Intervalos PD · Coverage 92%", "icon": "\U0001F4D0"},
    {"id": "causal", "label": "Causalidad (DML/CATE)", "layer": "model", "detail": "+1pp tasa \u2192 +0.787pp default", "icon": "\U0001F9EC"},
    {"id": "survival", "label": "Forecast + Survival", "layer": "model", "detail": "Cox C=0.6769 · RSF C=0.6838", "icon": "\u23F3"},
